...
const GradientButton = ({attributes, type, children}: PropsWithChildren<Props>) => {
  const typesStyle: { [key: string]: string } = {
    ...
    danger: 'bg-gradient-to-b from-red-600 to-red-400 hover:before:bg-red-800',
  }
  ...
  const buttonStyle = 'font-semibold relative z-10 py-1 px-4 text-white rounded-full duration-200'
