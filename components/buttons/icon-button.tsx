...
const IconButton = ({ attributes, icon: Icon, children }: PropsWithChildren<Props>) => {
  return (
    <button className='w-full flex items-center group gap-2 border-2 border-tournamento-400 rounded-full px-2 py-0.5 hover:bg-tournamento-400 duration-200' {...attributes}>
